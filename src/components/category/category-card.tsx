      ...
      <div className={cn('group min-w-72', className)}>
        <div className='group relative overflow-hidden rounded-xl shadow-md'>
          <img
            ...
            className={cn('h-74 aspect-video rounded-xl bg-black/5 object-cover transition-transform duration-200 group-hover:scale-105  group-hover:opacity-90', imageClassName)}
          />
