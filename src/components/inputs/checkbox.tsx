...
export default function CheckboxInput (
  ...
  return (
    <div className={cn('inline-flex gap-2 items-center', className)}>
      <label className="relative flex cursor-pointer items-center rounded-full" htmlFor={idCheckbox}>
        <input
          type="checkbox"
      ...
      <label className="mt-px cursor-pointer select-none text-sm font-medium text-gray-900 dark:text-white" htmlFor={idCheckbox}>
        {placeholder}
      </label>
    </div>
  )
